...
%Network t=0
\draw[fill=lightgray,opacity=0.9] (-1,0,-1) -- (3,0,-1) node[below] {$\scriptstyle t=0$} -- (3,0,3) -- (-1,0,3) -- (-1,0,-1);
\node[nc0] (a0) at (0,0,0) {};
\node[nc0] (b0) at (1,0,0) {};
\node[nc0] (c0) at (0,0,1) {};
\node[nc0] (d0) at (1,0,1) {};
...
%Network t=1
\draw[fill=lightgray,opacity=0.9] (-1,2,-1) -- (3,2,-1)  node[below] {$\scriptstyle t=1$} -- (3,2,3) -- (-1,2,3) -- (-1,2,-1);
\node[nc0] (a1) at (0,2,0) {};
\node[nc0] (b1) at (1,2,0) {};
\node[nc0] (c1) at (0,2,1) {};
\node[nc0] (d1) at (1,2,1) {};
...
\draw[-,gray] (a1) -- (a2)
                    ...
                    (f1) -- (f2);
%Network t=2
\draw[fill=lightgray,opacity=0.9] (-1,4,-1) -- (3,4,-1) node[below] {$\scriptstyle t=2$} -- (3,4,3) -- (-1,4,3) -- (-1,4,-1);
\node[nc0] (a2) at (0,4,0) {};
\node[nc0] (b2) at (1,4,0) {};
\node[nc0] (c2) at (0,4,1) {};
\node[nc1] (d2) at (1,4,1) {};
