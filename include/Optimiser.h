...
class Optimiser
{
  public:
    ...
    double move_nodes(MutableVertexPartition* partition, vector<bool> const& fixed_nodes, int consider_comms);
    double move_nodes(vector<MutableVertexPartition*> partitions, vector<double> layer_weights, vector<bool> const& fixed_nodes);
    ...
    double merge_nodes(MutableVertexPartition* partition, vector<bool> const& fixed_nodes, int consider_comms);
    double merge_nodes(vector<MutableVertexPartition*> partitions, vector<double> layer_weights, vector<bool> const& fixed_nodes);
    double merge_nodes(vector<MutableVertexPartition*> partitions, vector<double> layer_weights, vector<bool> const& fixed_nodes, int consider_comms);
